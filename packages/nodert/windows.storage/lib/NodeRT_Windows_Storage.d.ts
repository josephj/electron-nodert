declare module 'windows.storage' {
  ...
  export class StorageLibrary {
    ...
    static getLibraryForUserAsync(
      ...
      callback: (error: Error, result: StorageLibrary) => void
    ): void;
  ...
  export class StorageFolder {
    ...
    static getFolderFromPathAsync(
      path: String,
      callback: (error: Error, result: StorageFolder) => void
    ): void;

    createFileAsync(
      desiredName: String,
      callback: (error: Error, result: StorageFile) => void
    ): void;
    createFileAsync(
      desiredName: String,
  ...
  export class StorageFile {
    ...
    openTransactedWriteAsync(
      callback: (error: Error, result: StorageStreamTransaction) => void
    ): void;
    openTransactedWriteAsync(
      options: StorageOpenOptions,
      callback: (error: Error, result: StorageStreamTransaction) => void
  ...
  export class ApplicationData {
    ...
    static getForUserAsync(
      user: Object,
      callback: (error: Error, result: ApplicationData) => void
    ): void;
